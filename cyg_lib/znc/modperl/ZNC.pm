...
*GetCsockSSLIdx = *ZNCc::GetCsockSSLIdx;
...
*FormatServerTime = *ZNCc::CUtils_FormatServerTime;
*GetTimezones = *ZNCc::CUtils_GetTimezones;
*GetEncodings = *ZNCc::CUtils_GetEncodings;
*GetMessageTags = *ZNCc::CUtils_GetMessageTags;
*SetMessageTags = *ZNCc::CUtils_SetMessageTags;
sub DISOWN {
    my $self = shift;
    my $ptr = tied(%$self);
    delete $OWNER{$ptr};
...
*TLS11 = *ZNCc::Csock_TLS11;
*TLS12 = *ZNCc::Csock_TLS12;
*EDP_None = *ZNCc::Csock_EDP_None;
*EDP_SSLv2 = *ZNCc::Csock_EDP_SSLv2;
*EDP_SSLv3 = *ZNCc::Csock_EDP_SSLv3;
*EDP_TLSv1 = *ZNCc::Csock_EDP_TLSv1;
*EDP_TLSv1_1 = *ZNCc::Csock_EDP_TLSv1_1;
*EDP_TLSv1_2 = *ZNCc::Csock_EDP_TLSv1_2;
*EDP_SSL = *ZNCc::Csock_EDP_SSL;
...
*HasWriteBuffer = *ZNCc::Csock_HasWriteBuffer;
...
*SetHostToVerifySSL = *ZNCc::CZNCSock_SetHostToVerifySSL;
*GetSSLPeerFingerprint = *ZNCc::CZNCSock_GetSSLPeerFingerprint;
*SetSSLTrustedPeerFingerprints = *ZNCc::CZNCSock_SetSSLTrustedPeerFingerprints;
*SetEncoding = *ZNCc::CZNCSock_SetEncoding;
*GetRemoteIP = *ZNCc::CZNCSock_GetRemoteIP;
sub DISOWN {
    my $self = shift;
    my $ptr = tied(%$self);
    delete $OWNER{$ptr};
...
############# Class : ZNC::CIRCSocket ##############

package ZNC::CIRCSocket;
use vars qw(@ISA %OWNER %ITERATORS %BLESSEDMEMBERS);
@ISA = qw( ZNC::CZNCSock ZNC );
%OWNER = ();
%ITERATORS = ();
...
*OnChanPermission2 = *ZNCc::CModule_OnChanPermission2;
*OnChanPermission = *ZNCc::CModule_OnChanPermission;
*OnOp2 = *ZNCc::CModule_OnOp2;
*OnOp = *ZNCc::CModule_OnOp;
*OnDeop2 = *ZNCc::CModule_OnDeop2;
*OnDeop = *ZNCc::CModule_OnDeop;
*OnVoice2 = *ZNCc::CModule_OnVoice2;
*OnVoice = *ZNCc::CModule_OnVoice;
*OnDevoice2 = *ZNCc::CModule_OnDevoice2;
*OnDevoice = *ZNCc::CModule_OnDevoice;
*OnMode2 = *ZNCc::CModule_OnMode2;
*OnMode = *ZNCc::CModule_OnMode;
*OnRawMode2 = *ZNCc::CModule_OnRawMode2;
...
*OnJoining = *ZNCc::CModule_OnJoining;
...
*OnChanBufferPlayLine2 = *ZNCc::CModule_OnChanBufferPlayLine2;
*OnChanBufferPlayLine = *ZNCc::CModule_OnChanBufferPlayLine;
*OnPrivBufferPlayLine2 = *ZNCc::CModule_OnPrivBufferPlayLine2;
...
*OnSendToClient = *ZNCc::CModule_OnSendToClient;
*OnSendToIRC = *ZNCc::CModule_OnSendToIRC;
...
*MoveRegistry = *ZNCc::CModule_MoveRegistry;
...
*OnJoining = *ZNCc::CModules_OnJoining;
...
*OnChanBufferPlayLine2 = *ZNCc::CModules_OnChanBufferPlayLine2;
*OnChanBufferPlayLine = *ZNCc::CModules_OnChanBufferPlayLine;
*OnPrivBufferPlayLine2 = *ZNCc::CModules_OnPrivBufferPlayLine2;
...
*OnSendToClient = *ZNCc::CModules_OnSendToClient;
*OnSendToIRC = *ZNCc::CModules_OnSendToIRC;
...
*GetDefaultMods = *ZNCc::CModules_GetDefaultMods;
...
*InheritBufferCount = *ZNCc::CChan_InheritBufferCount;
...
*HasBufferCountSet = *ZNCc::CChan_HasBufferCountSet;
*HasAutoClearChanBufferSet = *ZNCc::CChan_HasAutoClearChanBufferSet;
...
*SetClientEncoding = *ZNCc::CUser_SetClientEncoding;
...
*SetAutoClearQueryBuffer = *ZNCc::CUser_SetAutoClearQueryBuffer;
...
*SetMaxQueryBuffers = *ZNCc::CUser_SetMaxQueryBuffers;
...
*GetClientEncoding = *ZNCc::CUser_GetClientEncoding;
...
*AutoClearQueryBuffer = *ZNCc::CUser_AutoClearQueryBuffer;
...
*MaxQueryBuffers = *ZNCc::CUser_MaxQueryBuffers;
...
*JOIN_FREQUENCY = *ZNCc::CIRCNetwork_JOIN_FREQUENCY;
*PING_FREQUENCY = *ZNCc::CIRCNetwork_PING_FREQUENCY;
*PING_SLACK = *ZNCc::CIRCNetwork_PING_SLACK;
*NO_TRAFFIC_TIMEOUT = *ZNCc::CIRCNetwork_NO_TRAFFIC_TIMEOUT;
...
*FindClients = *ZNCc::CIRCNetwork_FindClients;
...
*FindChans = *ZNCc::CIRCNetwork_FindChans;
*AddChan = *ZNCc::CIRCNetwork_AddChan;
*DelChan = *ZNCc::CIRCNetwork_DelChan;
*JoinChans = *ZNCc::CIRCNetwork_JoinChans;
*GetQueries = *ZNCc::CIRCNetwork_GetQueries;
*FindQuery = *ZNCc::CIRCNetwork_FindQuery;
*FindQueries = *ZNCc::CIRCNetwork_FindQueries;
*AddQuery = *ZNCc::CIRCNetwork_AddQuery;
*DelQuery = *ZNCc::CIRCNetwork_DelQuery;
...
*GetTrustedFingerprints = *ZNCc::CIRCNetwork_GetTrustedFingerprints;
*AddTrustedFingerprint = *ZNCc::CIRCNetwork_AddTrustedFingerprint;
*DelTrustedFingerprint = *ZNCc::CIRCNetwork_DelTrustedFingerprint;
...
*IRCConnected = *ZNCc::CIRCNetwork_IRCConnected;
...
*AddNoticeBuffer = *ZNCc::CIRCNetwork_AddNoticeBuffer;
*UpdateNoticeBuffer = *ZNCc::CIRCNetwork_UpdateNoticeBuffer;
*ClearNoticeBuffer = *ZNCc::CIRCNetwork_ClearNoticeBuffer;
...
*GetEncoding = *ZNCc::CIRCNetwork_GetEncoding;
*GetQuitMsg = *ZNCc::CIRCNetwork_GetQuitMsg;
...
*SetEncoding = *ZNCc::CIRCNetwork_SetEncoding;
*SetQuitMsg = *ZNCc::CIRCNetwork_SetQuitMsg;
...
*GetJoinDelay = *ZNCc::CIRCNetwork_GetJoinDelay;
*SetJoinDelay = *ZNCc::CIRCNetwork_SetJoinDelay;
...
*GetIdentifier = *ZNCc::CClient_GetIdentifier;
...
*HasBatch = *ZNCc::CClient_HasBatch;
*HasSelfMessage = *ZNCc::CClient_HasSelfMessage;
*IsValidIdentifier = *ZNCc::CClient_IsValidIdentifier;
...
*IsPlaybackActive = *ZNCc::CClient_IsPlaybackActive;
*SetPlaybackActive = *ZNCc::CClient_SetPlaybackActive;
...
*GetURIPrefix = *ZNCc::CListener_GetURIPrefix;
...
*GetRemoteIP = *ZNCc::CHTTPSock_GetRemoteIP;
...
*GetURIPrefix = *ZNCc::CHTTPSock_GetURIPrefix;
...
*GetLastActive = *ZNCc::CWebSession_GetLastActive;
*IsLoggedIn = *ZNCc::CWebSession_IsLoggedIn;
*IsAdmin = *ZNCc::CWebSession_IsAdmin;
*UpdateLastActive = *ZNCc::CWebSession_UpdateLastActive;
...
*ECONFIG_NEED_VERBOSE_WRITE = *ZNCc::CZNC_ECONFIG_NEED_VERBOSE_WRITE;
...
*ClearTrustedProxies = *ZNCc::CZNC_ClearTrustedProxies;
*AddTrustedProxy = *ZNCc::CZNC_AddTrustedProxy;
*RemTrustedProxy = *ZNCc::CZNC_RemTrustedProxy;
...
*SetHideVersion = *ZNCc::CZNC_SetHideVersion;
...
*GetTrustedProxies = *ZNCc::CZNC_GetTrustedProxies;
...
*GetHideVersion = *ZNCc::CZNC_GetHideVersion;
*GetSSLCiphers = *ZNCc::CZNC_GetSSLCiphers;
*GetDisabledSSLProtocols = *ZNCc::CZNC_GetDisabledSSLProtocols;
*CreateInstance = *ZNCc::CZNC_CreateInstance;
*Get = *ZNCc::CZNC_Get;
*DestroyInstance = *ZNCc::CZNC_DestroyInstance;
...
*OnChanPermission2 = *ZNCc::CPerlModule_OnChanPermission2;
*OnOp2 = *ZNCc::CPerlModule_OnOp2;
*OnDeop2 = *ZNCc::CPerlModule_OnDeop2;
*OnVoice2 = *ZNCc::CPerlModule_OnVoice2;
*OnDevoice2 = *ZNCc::CPerlModule_OnDevoice2;
*OnMode2 = *ZNCc::CPerlModule_OnMode2;
*OnRawMode2 = *ZNCc::CPerlModule_OnRawMode2;
...
*OnJoining = *ZNCc::CPerlModule_OnJoining;
...
*OnSendToClient = *ZNCc::CPerlModule_OnSendToClient;
*OnSendToIRC = *ZNCc::CPerlModule_OnSendToIRC;
sub DESTROY {
    return unless $_[0]->isa('HASH');
    my $self = tied(%{$_[0]});
    return unless defined $self;
