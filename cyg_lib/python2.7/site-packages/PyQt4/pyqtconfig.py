...
_pkg_config = {
    'pyqt_bin_dir':      '/usr/lib/python2.7/site-packages/PyQt4',
    'pyqt_config_args':  '--bindir /usr/lib/python2.7/site-packages/PyQt4 --concatenate --destdir /usr/lib/python2.7/site-packages --plugin-destdir /usr/lib/qt4/plugins --qmake /usr/bin/qmake-qt4 --assume-shared --confirm-license CFLAGS=-ggdb -O2 -pipe -Wimplicit-function-declaration -fdebug-prefix-map=/usr/src/ports/python-pyqt4/python-pyqt4-4.11.4-1.i686/build=/usr/src/debug/python-pyqt4-4.11.4-1 -fdebug-prefix-map=/usr/src/ports/python-pyqt4/python-pyqt4-4.11.4-1.i686/src/PyQt-x11-gpl-4.11.4=/usr/src/debug/python-pyqt4-4.11.4-1 CXXFLAGS=-ggdb -O2 -pipe -fdebug-prefix-map=/usr/src/ports/python-pyqt4/python-pyqt4-4.11.4-1.i686/build=/usr/src/debug/python-pyqt4-4.11.4-1 -fdebug-prefix-map=/usr/src/ports/python-pyqt4/python-pyqt4-4.11.4-1.i686/src/PyQt-x11-gpl-4.11.4=/usr/src/debug/python-pyqt4-4.11.4-1 STRIP=:',
    ...
    'pyqt_sip_dir':      '/usr/share/python-sip/PyQt4',
...
_default_macros = {
    ...
    'AR':                       'ar cqs',
    'CC':                       'gcc',
    'CFLAGS':                   '-ggdb -O2 -pipe -Wimplicit-function-declaration -fdebug-prefix-map=/usr/src/ports/python-pyqt4/python-pyqt4-4.11.4-1.i686/build=/usr/src/debug/python-pyqt4-4.11.4-1 -fdebug-prefix-map=/usr/src/ports/python-pyqt4/python-pyqt4-4.11.4-1.i686/src/PyQt-x11-gpl-4.11.4=/usr/src/debug/python-pyqt4-4.11.4-1',
    'CFLAGS_APP':               '',
    'CFLAGS_CONSOLE':           '',
    'CFLAGS_DEBUG':             '-g',
    ...
    'COPY':                     'cp -f',
    'CXX':                      'g++',
    'CXXFLAGS':                 '-ggdb -O2 -pipe -fdebug-prefix-map=/usr/src/ports/python-pyqt4/python-pyqt4-4.11.4-1.i686/build=/usr/src/debug/python-pyqt4-4.11.4-1 -fdebug-prefix-map=/usr/src/ports/python-pyqt4/python-pyqt4-4.11.4-1.i686/src/PyQt-x11-gpl-4.11.4=/usr/src/debug/python-pyqt4-4.11.4-1',
    'CXXFLAGS_APP':             '',
    'CXXFLAGS_CONSOLE':         '',
    'CXXFLAGS_DEBUG':           '-g',
