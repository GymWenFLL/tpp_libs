...
_pkg_config = {
    'pyqt_bin_dir':      '/usr/lib/python3.4/site-packages/PyQt4',
    'pyqt_config_args':  '--bindir /usr/lib/python3.4/site-packages/PyQt4 --concatenate --destdir /usr/lib/python3.4/site-packages --plugin-destdir /usr/lib/qt4/plugins --qmake /usr/bin/qmake-qt4 --assume-shared --confirm-license --no-designer-plugin --no-qsci-api CFLAGS=-ggdb -O2 -pipe -Wimplicit-function-declaration -fdebug-prefix-map=/usr/src/ports/python3-pyqt4/python3-pyqt4-4.11.4-1.i686/build=/usr/src/debug/python3-pyqt4-4.11.4-1 -fdebug-prefix-map=/usr/src/ports/python3-pyqt4/python3-pyqt4-4.11.4-1.i686/src/PyQt-x11-gpl-4.11.4=/usr/src/debug/python3-pyqt4-4.11.4-1 CXXFLAGS=-ggdb -O2 -pipe -fdebug-prefix-map=/usr/src/ports/python3-pyqt4/python3-pyqt4-4.11.4-1.i686/build=/usr/src/debug/python3-pyqt4-4.11.4-1 -fdebug-prefix-map=/usr/src/ports/python3-pyqt4/python3-pyqt4-4.11.4-1.i686/src/PyQt-x11-gpl-4.11.4=/usr/src/debug/python3-pyqt4-4.11.4-1 STRIP=:',
    'pyqt_mod_dir':      '/usr/lib/python3.4/site-packages/PyQt4',
    'pyqt_modules':      'QtCore QtGui QtHelp QtMultimedia QtNetwork QtDBus QtDeclarative QtScript QtScriptTools QtXml QtOpenGL QtSql QtSvg QtTest QtWebKit QtXmlPatterns phonon QtDesigner',
    'pyqt_sip_dir':      '/usr/share/python3-sip/PyQt4',
...
_default_macros = {
    ...
    'AR':                       'ar cqs',
    'CC':                       'gcc',
    'CFLAGS':                   '-ggdb -O2 -pipe -Wimplicit-function-declaration -fdebug-prefix-map=/usr/src/ports/python3-pyqt4/python3-pyqt4-4.11.4-1.i686/build=/usr/src/debug/python3-pyqt4-4.11.4-1 -fdebug-prefix-map=/usr/src/ports/python3-pyqt4/python3-pyqt4-4.11.4-1.i686/src/PyQt-x11-gpl-4.11.4=/usr/src/debug/python3-pyqt4-4.11.4-1',
    'CFLAGS_APP':               '',
    'CFLAGS_CONSOLE':           '',
    'CFLAGS_DEBUG':             '-g',
    ...
    'COPY':                     'cp -f',
    'CXX':                      'g++',
    'CXXFLAGS':                 '-ggdb -O2 -pipe -fdebug-prefix-map=/usr/src/ports/python3-pyqt4/python3-pyqt4-4.11.4-1.i686/build=/usr/src/debug/python3-pyqt4-4.11.4-1 -fdebug-prefix-map=/usr/src/ports/python3-pyqt4/python3-pyqt4-4.11.4-1.i686/src/PyQt-x11-gpl-4.11.4=/usr/src/debug/python3-pyqt4-4.11.4-1',
    'CXXFLAGS_APP':             '',
    'CXXFLAGS_CONSOLE':         '',
    'CXXFLAGS_DEBUG':           '-g',
