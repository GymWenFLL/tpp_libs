...
_pkg_config = {
    ...
    'default_mod_dir':    '/usr/lib/python3.4/site-packages',
    'default_sip_dir':    '/usr/share/python3-sip',
    'deployment_target':  '',
    'platform':           'cygwin-g++',
    ...
    'py_version':         0x030403,
    'qt_framework':       0,
    'sip_bin':            '/usr/lib/python3.4/site-packages/sip',
    'sip_config_args':    '-p cygwin-g++ -b /usr/lib/python3.4/site-packages -d /usr/lib/python3.4/site-packages -e /usr/include/python3.4m -v /usr/share/python3-sip CFLAGS+=-ggdb -O2 -pipe -Wimplicit-function-declaration -fdebug-prefix-map=/usr/src/ports/python3-sip/python3-sip-4.16.9-1.i686/build=/usr/src/debug/python3-sip-4.16.9-1 -fdebug-prefix-map=/usr/src/ports/python3-sip/python3-sip-4.16.9-1.i686/src/sip-4.16.9=/usr/src/debug/python3-sip-4.16.9-1 CXXFLAGS+=-ggdb -O2 -pipe -fdebug-prefix-map=/usr/src/ports/python3-sip/python3-sip-4.16.9-1.i686/build=/usr/src/debug/python3-sip-4.16.9-1 -fdebug-prefix-map=/usr/src/ports/python3-sip/python3-sip-4.16.9-1.i686/src/sip-4.16.9=/usr/src/debug/python3-sip-4.16.9-1',
    'sip_inc_dir':        '/usr/include/python3.4m',
    'sip_mod_dir':        '/usr/lib/python3.4/site-packages',
...
_default_macros = {
    ...
    'AR':                       'ar cqs',
    'CC':                       'gcc',
    'CFLAGS':                   '-pipe -ggdb -O2 -pipe -Wimplicit-function-declaration -fdebug-prefix-map=/usr/src/ports/python3-sip/python3-sip-4.16.9-1.i686/build=/usr/src/debug/python3-sip-4.16.9-1 -fdebug-prefix-map=/usr/src/ports/python3-sip/python3-sip-4.16.9-1.i686/src/sip-4.16.9=/usr/src/debug/python3-sip-4.16.9-1',
    'CFLAGS_APP':               '',
    'CFLAGS_CONSOLE':           '',
    'CFLAGS_DEBUG':             '-g',
    ...
    'COPY':                     'cp -f',
    'CXX':                      'g++',
    'CXXFLAGS':                 '-pipe -ggdb -O2 -pipe -fdebug-prefix-map=/usr/src/ports/python3-sip/python3-sip-4.16.9-1.i686/build=/usr/src/debug/python3-sip-4.16.9-1 -fdebug-prefix-map=/usr/src/ports/python3-sip/python3-sip-4.16.9-1.i686/src/sip-4.16.9=/usr/src/debug/python3-sip-4.16.9-1',
    'CXXFLAGS_APP':             '',
    'CXXFLAGS_CONSOLE':         '',
    'CXXFLAGS_DEBUG':           '-g',
