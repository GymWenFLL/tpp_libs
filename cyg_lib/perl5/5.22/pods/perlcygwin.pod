...
At the time this document was last updated, Cygwin 2.0.2 was current.
...
See L<http://cygwin.com/faq/faq.html#faq.using.fixing-fork-failures>
...
1. kill all perl processes and run C<</bin/find <dir> -xdev -name \*.dll | /bin/rebase -OT ->> or
