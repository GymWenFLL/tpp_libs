...
=head2 window or undef = $button-E<gt>B<get_event_window> 
...
=item 'child-displacement-x' (integer : default 0 : readable / private)

How far in the x direction to move the child when the button is depressed

=item 'child-displacement-y' (integer : default 0 : readable / private)

How far in the y direction to move the child when the button is depressed

=item 'default-border' (Gtk2::Border : default undef : readable / private)

Extra space to add for GTK_CAN_DEFAULT buttons

=item 'default-outside-border' (Gtk2::Border : default undef : readable / private)

Extra space to add for GTK_CAN_DEFAULT buttons that is always drawn outside the border

=item 'displace-focus' (boolean : default false : readable / private)

Whether the child_displacement_x/_y properties should also affect the focus rectangle

=item 'image-spacing' (integer : default 2 : readable / private)
