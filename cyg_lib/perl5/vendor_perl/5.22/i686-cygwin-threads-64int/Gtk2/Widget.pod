...
=item * $accel_path (string or undef) 

=item * $accel_group (Gtk2::AccelGroup or undef) 
...
=head2 rectangle = $widget-E<gt>B<get_allocation> 

Since: gtk+ 2.18

=head2 $widget-E<gt>B<set_allocation> ($allocation)
...
=head2 boolean = $widget-E<gt>B<get_app_paintable> 
...
=head2 boolean = $widget-E<gt>B<get_can_default> 

Since: gtk+ 2.18

=head2 $widget-E<gt>B<set_can_default> ($can_default)

=over

=item * $can_default (boolean) 
...
=head2 boolean = $widget-E<gt>B<get_can_focus> 

Since: gtk+ 2.18

=head2 $widget-E<gt>B<set_can_focus> ($can_focus)

=over

=item * $can_focus (boolean) 
...
=head2 string or undef = $widget-E<gt>B<get_composite_name> 
...
=head2 layout = $widget-E<gt>B<create_pango_layout> ($text=undef)
...
=head2 boolean = $widget-E<gt>B<get_double_buffered> 
...
=head2 pspec or undef = $widget_or_class_name->B<find_style_property> ($name)
...
=head2 boolean = $widget-E<gt>B<has_rc_style> 
...
=head2 boolean = $widget-E<gt>B<get_has_window> 

Since: gtk+ 2.18

=head2 $widget-E<gt>B<set_has_window> ($has_window)

=over

=item * $has_window (boolean) 
...
=head2 boolean = $widget-E<gt>B<is_composited> 

Since: gtk+ 2.10

=head2 boolean = $widget-E<gt>B<is_drawable> 
...
=head2 boolean = $widget-E<gt>B<is_toplevel> 
...
=head2 list = $widget_or_class_name->B<list_style_properties>
...
=head2 boolean = $widget-E<gt>B<get_mapped> 

Since: gtk+ 2.20

=head2 $widget-E<gt>B<set_mapped> ($mapped)
...
=item * $primary (Gtk2::Gdk::Color or undef) 

=item * $secondary (Gtk2::Gdk::Color or undef) 
...
=head2 boolean = $widget-E<gt>B<get_realized> 

Since: gtk+ 2.20

=head2 $widget-E<gt>B<set_realized> ($realized)

=over

=item * $realized (boolean) 
...
=head2 boolean = $widget-E<gt>B<get_receives_default> 

Since: gtk+ 2.18

=head2 $widget-E<gt>B<set_receives_default> ($receives_default)

=over

=item * $receives_default (boolean) 
...
=head2 requisition = $widget-E<gt>B<get_requisition> 
...
=head2 boolean = $widget-E<gt>B<send_focus_change> ($event)
...
=head2 boolean = $widget-E<gt>B<get_sensitive> 
...
=head2 statetype = $widget-E<gt>B<get_state> 
...
=head2 $style-E<gt>B<style_attach> 
...
=head2 widget = $widget-E<gt>B<get_toplevel> 
...
=head2 boolean = $widget-E<gt>B<get_visible> 

Since: gtk+ 2.18

=head2 $widget-E<gt>B<set_visible> ($visible)
...
=head2 window or undef = $widget-E<gt>B<get_window> 

Since: gtk+ 2.14

=head2 $widget-E<gt>B<set_window> ($window)
...
=item 'cursor-aspect-ratio' (float : default 0.04 : readable / private)

Aspect ratio with which to draw insertion cursor

=item 'cursor-color' (Gtk2::Gdk::Color : default undef : readable / private)

Colour with which to draw insertion cursor

=item 'draw-border' (Gtk2::Border : default undef : readable / private)

Size of areas outside the widget's allocation to draw

=item 'focus-line-pattern' (string : default "\1\1" : readable / private)

Dash pattern used to draw the focus indicator

=item 'focus-line-width' (integer : default 1 : readable / private)

Width, in pixels, of the focus indicator line

=item 'focus-padding' (integer : default 1 : readable / private)

Width, in pixels, between focus indicator and the widget 'box'

=item 'interior-focus' (boolean : default true : readable / private)

Whether to draw the focus indicator inside widgets

=item 'link-color' (Gtk2::Gdk::Color : default undef : readable / private)

Colour of unvisited links

=item 'scroll-arrow-hlength' (integer : default 16 : readable / private)

The length of horizontal scroll arrows

=item 'scroll-arrow-vlength' (integer : default 16 : readable / private)

The length of vertical scroll arrows

=item 'secondary-cursor-color' (Gtk2::Gdk::Color : default undef : readable / private)

Colour with which to draw the secondary insertion cursor when editing mixed right-to-left and left-to-right text

=item 'separator-height' (integer : default 0 : readable / private)

The height of separators if "wide-separators" is TRUE

=item 'separator-width' (integer : default 0 : readable / private)

The width of separators if wide-separators is TRUE

=item 'tooltip-alpha' (Glib::UChar : default 255 : readable / private)

The opacity to be used when drawing tooltips

=item 'tooltip-radius' (Glib::UInt : default 0 : readable / private)

The radius to be used when drawing tooltips

=item 'visited-link-color' (Gtk2::Gdk::Color : default undef : readable / private)

Colour of visited links

=item 'wide-separators' (boolean : default false : readable / private)

Whether separators have configurable width and should be drawn using a box instead of a line

=item 'window-dragging' (boolean : default false : readable / writable / private)
...
=item boolean = B<drag-failed> (Gtk2::Widget, Gtk2::Gdk::DragContext, Gtk2::DragResult)
