...
=head2 adjustment = $text_view-E<gt>B<get_hadjustment> 

Since: gtk+ 2.22

=head2 boolean = $text_view-E<gt>B<im_context_filter_keypress> ($event)
...
=head2 $text_view-E<gt>B<reset_im_context> 
...
=head2 adjustment = $text_view-E<gt>B<get_vadjustment> 
...
=item 'error-underline-color' (Gtk2::Gdk::Color : default undef : readable / private)

Colour with which to draw error-indication underlines
