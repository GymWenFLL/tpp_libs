...
=head2 sensitivitytype = $combo_box-E<gt>B<get_button_sensitivity> 

Since: gtk+ 2.14

=head2 $combo_box-E<gt>B<set_button_sensitivity> ($sensitivity)
...
=item 'appears-as-list' (boolean : default false : readable / private)

Whether dropdowns should look like lists rather than menus

=item 'arrow-size' (integer : default 15 : readable / private)

The minimum size of the arrow in the combo box

=item 'shadow-type' (Gtk2::ShadowType : default "none" : readable / private)
