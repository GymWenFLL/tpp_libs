...
=item 'allow-rules' (boolean : default true : readable / private)

Allow drawing of alternating colour rows

=item 'even-row-color' (Gtk2::Gdk::Color : default undef : readable / private)

Colour to use for even rows

=item 'expander-size' (integer : default 12 : readable / private)

Size of the expander arrow

=item 'grid-line-pattern' (string : default "\1\1" : readable / private)

Dash pattern used to draw the tree view grid lines

=item 'grid-line-width' (integer : default 1 : readable / private)

Width, in pixels, of the tree view grid lines

=item 'horizontal-separator' (integer : default 2 : readable / private)

Horizontal space between cells.  Must be an even number

=item 'indent-expanders' (boolean : default true : readable / private)

Make the expanders indented

=item 'odd-row-color' (Gtk2::Gdk::Color : default undef : readable / private)

Colour to use for odd rows

=item 'row-ending-details' (boolean : default false : readable / private)

Enable extended row background theming

=item 'tree-line-pattern' (string : default "\1\1" : readable / private)

Dash pattern used to draw the tree view lines

=item 'tree-line-width' (integer : default 1 : readable / private)

Width, in pixels, of the tree view lines

=item 'vertical-separator' (integer : default 2 : readable / private)
